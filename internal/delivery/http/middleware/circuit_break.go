...
// CircuitBreakTransport adalah decorator untuk http.RoundTripper
type CircuitBreakTransport struct {
	Transport http.RoundTripper
	CB        *gobreaker.CircuitBreaker
}

// RoundTrip menjalankan request dengan proteksi sekering
func (c *CircuitBreakTransport) RoundTrip(req *http.Request) (*http.Response, error) {
